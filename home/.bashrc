...
# Hand off interactive sessions to zsh (brew). WSL-friendly alternative to chsh.
# Escape hatch: NO_ZSH=1 bash
if [ -z "$NO_ZSH" ] && [ -x /home/linuxbrew/.linuxbrew/bin/zsh ]; then
...
# Starship prompt (fallback for NO_ZSH=1 sessions)
...
# Ctrl+L clears the screen (restore default readline binding)
